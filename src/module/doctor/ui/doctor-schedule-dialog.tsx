...
export function DoctorScheduleDialog({ open, onClose, doctorId, doctorName }: Props) {
    ...
    const [selectedTime, setSelectedTime] = useState<Dayjs | null>(dayjs().set('hour', 9).set('minute', 0));
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
            <DialogTitle sx={{ pb: 1 }}>
                ...
                <Typography variant="body2" color="text.secondary">{doctorName}</Typography>
            </DialogTitle>
